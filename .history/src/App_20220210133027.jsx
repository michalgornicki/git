...
function App() {
  ...
  return (
    ...
    <div className="text-center">
      ...
      <Link className="link-style mx-3" to="/">Basics</Link>
      <Link className="link-style mx-3" to="/Numbers">Structure</Link>
      <Link className="link-style mx-3" to="/Variables"></Link>
      <Link className="link-style mx-3" to="/Loops"></Link>
      <Link className="link-style mx-3" to="/Async"></Link>
      <Link className="link-style mx-3" to="/DOM"></Link>
      <Link className="link-style mx-3" to="/Window"></Link>
